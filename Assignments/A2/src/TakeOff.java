...
/**
 * TakeOff class implements methods from Trick interface.
 * Creates a specific sequence of movements.
 * For TakeOff, users can only modify recording and distance.
 * TakeOff is then passed on to Drone for execution, or can be added to a Flight.
 * 
...
public class TakeOff implements Trick {
     ...
     */
    public TakeOff() {
        this.trickName = "TakeOff";
        this.moves = new ArrayList<>();
        Movement m1 = new Movement(Direction.UP, Speed.LOW);
        Movement m2 = new Movement(Direction.UP, Speed.MODERATE);
        moves.add(m1);
        moves.add(m2);
    }
